...
public class RequestLogin {
	...
	public String requestKakao() {
		...
		requestURL +="&redirect_uri=http://visualup.koreacentral.cloudapp.azure.com:8080/login?type=kakao";
	...
	public String requestGoogle() {
	    ...
	    requestURL += "&redirect_uri="+URLEncoder.encode("http://visualup.koreacentral.cloudapp.azure.com:8080/login?type=google");
