...
public class RequestLogin {
	...
	public String requestKakao() {
		...
		requestURL +="&redirect_uri=https://visualup.koreacentral.cloudapp.azure.com/login?type=kakao";
	...
	public String requestGoogle() {
	    ...
	    requestURL += "&redirect_uri="+URLEncoder.encode("https://visualup.koreacentral.cloudapp.azure.com/login?type=google");
	...
	public String requestGithub() {
		...
		requestURL += "&redirect_uri=https://visualup.koreacentral.cloudapp.azure.com/login?type=github";
